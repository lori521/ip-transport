...
bool tcp_layer::establish_connection_receiver(int socketfd, tcp_pseudoheader *pshdr_addr, uint16_t dest_port, uint16_t src_port) {
    ...
    decap_check = received_packet.decapsulate_package(pshdr_addr, temp_buffer, rc);
...
// -> receive ACK (seq#B + 1)
// -> send ACK (seq#B + 1)
bool tcp_layer::establish_connection_sender(int socketfd, tcp_pseudoheader *pshdr_addr, uint16_t dest_port, uint16_t src_port, struct sockaddr_in *receiver_addr) {
...
bool tcp_layer::finish_connection_receiver(int socketfd, tcp_pseudoheader *pshdr_addr, uint16_t dest_port, uint16_t src_port) {
...
bool tcp_layer::finish_connection_sender(int socketfd, tcp_pseudoheader *pshdr_addr, uint16_t dest_port, uint16_t src_port, struct sockaddr_in *receiver_addr) {
